...
import zibranlab.yourtaskapp.Model.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read_webnews=findViewById(R.id.read_news);
        ...
        read_webnews.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent=new Intent(HomeActivity.this,read_news.class);
